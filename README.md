...
Based on [@antfu/eslint-config](https://github.com/antfu/eslint-config), with some personal rules added.

[![npm](https://img.shields.io/npm/v/@mlong/eslint-config?color=444&label=)](https://npmjs.com/package/@mlong/eslint-config) [![code style](https://antfu.me/badge-code-style.svg)](https://github.com/antfu/eslint-config)
...
```bash
pnpm dlx @mlong/eslint-config@latest
```
...
```bash
pnpm i -D eslint @mlong/eslint-config
```
...
```js
// eslint.config.mjs
import antfu from '@mlong/eslint-config'
